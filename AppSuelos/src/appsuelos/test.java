...
public final class test {
     ...
     */
        private static void testCreateSampleSheet2(String outputFilename) throws IOException {
		int rownum;
		HSSFWorkbook wb = new HSSFWorkbook();
		HSSFSheet s = wb.createSheet();
		HSSFCellStyle cs = wb.createCellStyle();
	...
	public static void main(String[] args) throws IOException {
            test.testCreateSampleSheet2("prueba2.xls");
		String fileName = "pruba.xls";
		try {
			if (args.length < 2) {

				HSSFWorkbook wb = test.readFile(fileName);
				...
				if (args[1].toLowerCase().equals("write")) {
					...
					test.testCreateSampleSheet(fileName);
